...
Provides lossless memory for OpenCode code agents.

Usage:
    from agent_memory.adapters import OpenCodeMemory
    
    memory = OpenCodeMemory(base_path="./my_memory")
...
class OpenCodeMemory:
    """
    Memory adapter for OpenCode code agents.
    ...
    Usage:
        ...
        memory = OpenCodeMemory(base_path="./opencode_memory")
    ...
    def __init__(
        ...
        base_path: str = "./opencode_memory",
        memory_preset: Optional[str] = None,
        config: Optional[AdapterConfig] = None,
    ):
        """Initialize OpenCode memory."""
        ...
        logger.info("OpenCodeMemory initialized")
